...
export default function PrototypeNotice({ className = "" }: { className?: string }) {
  return (
    ...
    >
      <IconInfo className="mt-0.5 h-4 w-4 shrink-0 text-[#241f1a]" />
      <p>
        <span className="font-medium text-[#241f1a]">Prototype:</span> nothing you upload, describe, or draw here is
