      ...
      {phase === "refining" ? (
        ...
        <div className="relative flex flex-1 flex-col items-center justify-center overflow-y-auto px-6 py-10">
          ...
          <div className="animate-fade-up mt-8 flex w-full max-w-xs flex-col gap-2.5 [animation-delay:200ms]">
            <button
              onClick={onKeep}
              className="flex items-center justify-center gap-2 rounded-full bg-[#c8a96b] py-3.5 text-[12.5px] font-medium uppercase tracking-[0.16em] text-[#241f1a] transition-transform hover:-translate-y-0.5"
            >
