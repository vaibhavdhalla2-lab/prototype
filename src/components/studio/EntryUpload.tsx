    ...
    <div className="mx-auto max-w-lg px-5 py-16 sm:px-8 sm:py-24">
      ...
      {staged && !analysis && (
        <div className="mt-8 animate-scale-in">
          ...
          <div className="mx-auto mt-6 flex max-w-xs flex-col gap-2.5">
            <button onClick={useAsArtwork} className="rounded-full bg-[#c8a96b] py-3 text-[12px] uppercase tracking-[0.12em] text-[#241f1a]">
              Use As Artwork
            </button>
      ...
      {analysis && (
        <div className="mt-8 animate-scale-in rounded-3xl border border-clay/30 bg-clay/[0.06] p-6">
          ...
          <button onClick={applyRecommendations} className="mt-5 flex w-full items-center justify-center gap-2 rounded-full bg-[#c8a96b] py-3 text-[12px] uppercase tracking-[0.14em] text-[#241f1a]">
